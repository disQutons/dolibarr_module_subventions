...
/**
 *  \file       subvention_note.php
 *  \ingroup    subventions
 *  \brief      Tab for notes on Subvention
 */
...
$title = $langs->trans('Subsidy').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Subsidy"), -1, $object->picto);
