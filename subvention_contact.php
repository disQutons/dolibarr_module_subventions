...
/**
 *  \file       subvention_contact.php
 *  \ingroup    subventions
 *  \brief      Tab for contacts linked to Subvention
 */
...
$title = $langs->trans("Subsidy")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Subsidy"), -1, $object->picto);
