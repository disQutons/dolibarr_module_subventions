...
/**
 *  \file       financement_contact.php
 *  \ingroup    subventions
 *  \brief      Tab for contacts linked to Financement
 */
...
$title = $langs->trans("Funding")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Funding"), -1, $object->picto);
