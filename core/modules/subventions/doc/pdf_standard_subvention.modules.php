...
/**
 *  \file       core/modules/subventions/doc/pdf_standard.modules.php
 *  \ingroup    subventions
...
/**
 *	Class to manage PDF template standard_subvention
 */
class pdf_standard_subvention extends ModelePDFSubvention
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	Subvention	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('SUBVENTIONS_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('SUBVENTIONS_DRAFT_WATERMARK')));
		}
