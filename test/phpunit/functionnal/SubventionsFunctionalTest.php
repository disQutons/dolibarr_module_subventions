...
/**
 * \file    test/phpunit/SubventionsFunctionalTest.php
 * \ingroup subventions
...
/**
 * Class SubventionsFunctionalTest
 *
 ...
 *
 * @package Testsubventions
 */
class SubventionsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 173321;
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modSubventions')->click();
		} else {
			// Disable the module
			$this->byHref('modSubventions')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/subventions/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('subventions/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/subventions/admin/about.php');
		$this->authenticate();
		return $this->assertContains('subventions/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('subventionswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modSubventions_SubventionsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modSubventions_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
