...
/**
 *       \file       htdocs/subventions/ajax/subvention.php
 *       \brief      File to return Ajax response on subvention list request
 */
...
// Security check
if (!$user->hasRight('subventions', 'subvention', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax subventions/ajax/subvention.php");
