...
/**
 *       \file       htdocs/subventions/ajax/financement.php
 *       \brief      File to return Ajax response on financement list request
 */
...
// Security check
if (!$user->hasRight('subventions', 'financement', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax subventions/ajax/financement.php");
