...
/**
 *       \file       htdocs/subventions/ajax/paiement.php
 *       \brief      File to return Ajax response on paiement list request
 */
...
// Security check
if (!$user->hasRight('subventions', 'paiement', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax subventions/ajax/paiement.php");
