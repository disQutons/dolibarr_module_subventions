...
/**
 *  \file       subvention_agenda.php
 *  \ingroup    subventions
 *  \brief      Tab of events on Subvention
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Subsidy")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Subsidy"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_subvention_'.$object->id;
