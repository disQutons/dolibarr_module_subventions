...
/**
 *   	\file       financement_list.php
 *		\ingroup    subventions
 *		\brief      List page for financement
 */
...
require_once __DIR__.'/class/financement.class.php';
// for other modules
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Financement';
	$objectlabel = 'Financement';
...
if ($socid && $user->hasRight('societe', 'lire')) {
	...
	if ($res > 0) {
		...
		print dol_get_fiche_head($head, 'financements', $langs->trans("ThirdParty"), -1, 'company');
...
$topicmail = "SendFinancementRef";
$modelmail = "financement";
$objecttmp = new Financement($db);
