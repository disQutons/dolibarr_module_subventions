				...
				<tr class="toptitle">
					...
					<td class="nobordernopadding titre_right wordbreakimp right valignmiddle col-right">
						<div class="inline-block valignmiddle">
							<a class="buttonxxx marginleftonly" href="/custom/subventions/financement_card.php?action=create&amp;origin=subvention&amp;fk_sub='.$id.'" title="Créer un financeur">
		...
		print'<table class="notopnoleftnoright table-fiche-title showlinkedobjectblock">
			<tbody>
				<tr class="toptitle">
					...
					<td class="nobordernopadding titre_right wordbreakimp right valignmiddle col-right">
						<div class="inline-block valignmiddle">
							<a class="buttonxxx marginleftonly" href="/custom/subventions/paiement_card.php?action=create&amp;origin=subvention&amp;fk_sub='.$id.'" title="Créer un financeur">
								<span class="fa fa-plus-circle valignmiddle paddingleft"></span>
							</a>
						<div></div></div>
					</td>
